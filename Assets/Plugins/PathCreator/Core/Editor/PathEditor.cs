...
namespace PathCreationEditor
{
    ...
    public class PathEditor : Editor
    {
            ...
            using (var check = new EditorGUI.ChangeCheckScope())
            {
                ...
                if (data.showDisplayOptions)
                {
                    ...
                    data.bezierHandleScale =
                        Mathf.Max(0, EditorGUILayout.FloatField(new GUIContent("Handle Scale"), data.bezierHandleScale));
        ...
        void DrawVertexPathInspector()
        {
            ...
            data.showVertexPathOptions = EditorGUILayout.Foldout(data.showVertexPathOptions, new GUIContent("Vertex Path Options"), true,
                boldFoldoutStyle);
        ...
        void ProcessBezierPathInput(Event e)
        {
            ...
            for (int i = 0; i < bezierPath.NumPoints; i += 3)
            {
                ...
                float handleRadius = GetHandleDiameter(globalDisplaySettings.anchorSize * data.bezierHandleScale, bezierPath[handleIndex]) /
                                     2f;
        ...
        void DrawBezierPathSceneEditor()
        {
            ...
            if (Event.current.type == EventType.Repaint)
            {
                for (int i = 0; i < bezierPath.NumSegments; i++)
                {
                    ...
                    // Draw path
                    bool highlightSegment = (i == selectedSegmentIndex && Event.current.shift && draggingHandleIndex == -1 &&
                                             mouseOverHandleIndex == -1);
        ...
        void DrawHandle(int i)
        {
            ...
            {
                handleColours.defaultColour =
                    (isAnchorPoint) ? globalDisplaySettings.anchorSelected : globalDisplaySettings.controlSelected;
            }
        ...
        void UpdateGlobalDisplaySettings()
        {
            ...
            splineControlColours =
                new PathHandle.HandleColours(gds.control, gds.controlHighlighted, gds.controlSelected, gds.handleDisabled);
        ...
        bool editingNormals
        {
            get { return Tools.current == Tool.Rotate && handleIndexToDisplayAsTransform % 3 == 0 && bezierPath.Space == PathSpace.xyz; }
        }
